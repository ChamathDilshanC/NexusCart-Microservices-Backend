...
<body>
    ...
    <div class="container">
      ...
      <h3 id="public-catalog">Public Catalog</h3>
      <table>
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="path-col">/api/products</td>
            <td class="desc-col">List all products</td>
          </tr>
          <tr>
            <td class="method-col">
              <span class="badge badge-get">GET</span>
            </td>
            <td class="path-col">/api/products/:id</td>
            <td class="desc-col">Get product by ID</td>
          </tr>
        </tbody>
      </table>
    
      <h3 id="vendor-actions">Vendor Actions</h3>
      <table>
        <thead>
          <tr>
            <th style="width: 20%;">Method</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="path-col">/api/products</td>
            <td class="desc-col">Create a new product (Vendor only)</td>
          </tr>
          <tr>
            <td class="method-col">
              <span class="badge badge-get">GET</span>
            </td>
            <td class="path-col">/api/products/vendor/me</td>
            <td class="desc-col">List products for logged in vendor</td>
          </tr>
        </tbody>
      </table>
...
<a href="#vendor-actions">Vendor Actions</a>
