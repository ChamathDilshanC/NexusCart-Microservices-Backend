...
<body>
    ...
    <main>
        ...
        <p class="header-subtitle">Welcome to the interactive documentation for the NexusCart Product Service. Explore available endpoints and integrate seamlessly with our modern infrastructure.</p>
        ...
        <div class="glass-card">
            ...
            <div class="api-endpoint">
                ...
                <span class="description">Access the Product Service documentation</span>
            </div>
            
            <div class="api-endpoint">
                <span class="method get">GET</span>
                <span class="path">/api/products/health</span>
