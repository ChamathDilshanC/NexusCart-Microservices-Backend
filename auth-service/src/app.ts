      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="path-col">/api/auth/register</td>
            <td class="desc-col">Register a new user</td>
          </tr>
          <tr>
            <td class="method-col">
              <span class="badge badge-post">POST</span>
            </td>
            <td class="path-col">/api/auth/verify-otp</td>
            <td class="desc-col">Verify email OTP</td>
          </tr>
          <tr>
            <td class="method-col">
              <span class="badge badge-post">POST</span>
            </td>
            <td class="path-col">/api/auth/login</td>
            <td class="desc-col">Login to get JWT token</td>
          </tr>
          <tr>
            <td class="method-col">
              <span class="badge badge-get">GET</span>
            </td>
            <td class="path-col">/api/auth/profile</td>
            <td class="desc-col">Get current user profile (Auth required)</td>
          </tr>
        </tbody>
      </table>
