...
<body>
    ...
    <main>
        <h1 class="header-title">Authentication Service</h1>
        <p class="header-subtitle">Welcome to the interactive documentation for the NexusCart Authentication Service. Explore available endpoints and integrate seamlessly with our modern infrastructure.</p>
        ...
        <div class="glass-card">
            ...
            <div class="api-endpoint">
                ...
                <span class="description">Access the Authentication Service documentation</span>
            </div>
            
            <div class="api-endpoint">
                <span class="method get">GET</span>
                <span class="path">/api/auth/health</span>
