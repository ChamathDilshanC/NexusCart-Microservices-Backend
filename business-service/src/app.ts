...
<head>
    ...
    <title>Business Service - API Documentation</title>
...
<body>
    ...
    <main>
        <h1 class="header-title">Business Service</h1>
        <p class="header-subtitle">Welcome to the interactive documentation for the NexusCart Business Service. Explore available endpoints and integrate seamlessly with our modern infrastructure.</p>
        ...
        <div class="glass-card">
            ...
            <div class="api-endpoint">
                ...
                <span class="path">/api/business</span>
                <span class="description">Access the Business Service documentation</span>
            </div>
            
            <div class="api-endpoint">
                <span class="method get">GET</span>
                <span class="path">/api/business/health</span>
