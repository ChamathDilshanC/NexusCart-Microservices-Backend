...
<head>
    ...
    <title>Business Service Documentation</title>
...
<body>
    ...
    <div class="container">
      ...
      <h3 id="vendor-business">Vendor Business</h3>
      <table>
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="path-col">/api/business/register</td>
            <td class="desc-col">Register a new business (Vendor only)</td>
          </tr>
          <tr>
            <td class="method-col">
              <span class="badge badge-get">GET</span>
            </td>
            <td class="path-col">/api/business/my-business</td>
            <td class="desc-col">Get logged in vendor business details</td>
          </tr>
        </tbody>
      </table>
        ...
        <div class="right-sidebar">
            ...
            <a href="#vendor-business">Vendor Business</a>
